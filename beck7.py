                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target]) # KALAU MAU BUAT BANYAK SILAHKAN TAMBAHIN SESUKA KALIAN :>
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target]) # HANYA SPAM VIA CONTACT
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target])
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target])
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target])
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target])
                                cl.createGroup("JEMBUTTTT LEBATTTT",[target])
